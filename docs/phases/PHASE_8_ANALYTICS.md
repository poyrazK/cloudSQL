...
### 1. Columnar Storage Layer (`storage/columnar_table.cpp`)
...
### 2. Vectorized Data Structures (`executor/types.hpp`)
...
### 3. Vectorized Execution Engine (`executor/vectorized_operator.hpp`)
