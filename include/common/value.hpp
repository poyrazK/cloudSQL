...
// Constructors
inline Value::Value() : type_(TYPE_NULL), data_(std::monostate{}) {}
...
inline Value::Value(bool v) : type_(TYPE_BOOL), data_(v) {}

inline Value::Value(int8_t v) : type_(TYPE_INT8), data_(static_cast<int64_t>(v)) {}

inline Value::Value(int16_t v) : type_(TYPE_INT16), data_(static_cast<int64_t>(v)) {}

inline Value::Value(int32_t v) : type_(TYPE_INT32), data_(static_cast<int64_t>(v)) {}

inline Value::Value(int64_t v) : type_(TYPE_INT64), data_(v) {}

inline Value::Value(float v) : type_(TYPE_FLOAT32), data_(static_cast<double>(v)) {}

inline Value::Value(double v) : type_(TYPE_FLOAT64), data_(v) {}

inline Value::Value(const std::string& v) : type_(TYPE_TEXT), data_(v) {}

inline Value::Value(const char* v) : type_(TYPE_TEXT), data_(std::string(v)) {}
